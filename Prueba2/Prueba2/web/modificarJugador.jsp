                    ...
                    <form action="servletJugador" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <table  class="table" border="8">
                                    <c:choose>
                                    <c:when test="${cboOpcion.enter==reg.id_participante}">
                                    <c:forEach var="reg" items="${registros.rows}">
                                    <tr>
                                        <td>Nombre:</td>
                                        <td><input type="text" name="txtNombre" value="${reg.nombre}" required /></td>
                                    </tr>
                                    <tr>
                                        <td>Rol</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Posicion</td>
                                        <td>
                                            <input type="number" name="txtPosicion" min="1" max="5" value="${reg.posicion}"  required />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Fecha de Nacimiento</td>
                                        <td>
                                            <input type="date" name="dtFechaNacimiento" value="${reg.fecha_nacimiento}" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                    <sql:setDataSource user="root" password="" driver="com.mysql.jdbc.Driver" 
